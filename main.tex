...
\section{温室の設計}
シミュレーションを行うにあたって、まずは温室の設置場所と設計を決定した。設置場所は取得可能な気象データの場所から茨城県つくば市とした。また温室の設計は\tab{housedesign}に示すパラメータを用いた。
...
% \begin{figure}[t]
%     \centering
%     \subfigure[Subfigure name 1.]{\includegraphics[width=0.45\linewidth]{sample.pdf}\label{fig:subfigure_name_1}}
%     \subfigure[Subfigure name 2.]{\includegraphics[width=0.45\linewidth]{sample.pdf}\label{fig:subfigure_name_2}}
